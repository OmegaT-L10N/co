...
Installazione d’OmegaT (Windows)
================================

Lanciate u prugramma d’installazione.
...
Installazione d’OmegaT (Solaris, FreeBSD, etc.)
===============================================
...
A cumanda chì permette di lancià OmegaT hè :
    ...
    <nome è chjassu di u schedariu d’esecuzione Java> -jar OmegaT.jar

(U schedariu d’esecuzione Java hè u schedariu java nant’à Linux è java.exe nant’à Windows.  S’è Java hè installatu à u livellu di u sistema è inchjusu in u chjassu, ùn hè micca bisognu di scrive u chjassu sanu.)
